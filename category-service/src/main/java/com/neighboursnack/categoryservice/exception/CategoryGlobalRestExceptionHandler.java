package com.neighboursnack.categoryservice.exception;
...
public class CategoryGlobalRestExceptionHandler {

    @ExceptionHandler(CategoryException.class)
    @ResponseStatus(BAD_REQUEST)
    public ErrorResponseDTO handleCategoryException(CategoryException se, HttpServletRequest request) {
